...
(function() {
  ...
  var GUIDES = {
    ...
    'suivi-contrat':       { title: 'Suivi de contrat',      intro: 'Generez une annexe de suivi de contrat client avec TRI (XIRR), allocation, contexte macro et commentaires.', steps: ['Collez l\'export du contrat dans la zone Import','Cliquez sur Importer & analyser pour parser automatiquement','Verifiez/completez les informations dans la sidebar','Commentez chaque ligne des sections 1-5','Redigez la note globale du point annuel','Exportez en PDF via Ctrl+P ou le bouton vert'], tips: ['Le TRI est calcule par la methode XIRR (Newton-Raphson)','Les OST, arbitrages internes et versements d\'interets sont exclus du calcul','Les mouvements significatifs (>=1000EUR) sont extraits automatiquement'] },
