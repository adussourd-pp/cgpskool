...
(function() {
  ...
  var GUIDES = {
    ...
    'allocation-cible':    { title: 'Allocation Cible',       intro: 'Dynamisez une poche (fonds euros) vers des fonds actions et visualisez l\'allocation finale.', steps: ['Renseignez le versement brut, les frais et le minimum par arbitrage du contrat','Saisissez l\'allocation de depart (dont la poche a dynamiser)','Choisissez le fonds source, le montant a dynamiser et la duree','Definissez les fonds de destination (fonds actions) en %','Lisez l\'allocation finale et les camemberts avant / apres'], tips: ['Le montant par arbitrage se calcule automatiquement (montant / nombre d\'arbitrages)','Mode \"jusqu\'a epuisement\" : vous fixez le montant/arbitrage, la duree se deduit','Le minimum par arbitrage sert uniquement d\'alerte de controle','Ouvrez le \"Mode d\'emploi\" complet depuis le bas de la sidebar'] },
    ...
    'dossier-solution':    { title: 'Dossier Immobilier',       intro: 'Generez un dossier solution immobilier a remettre au client : presentation du bien, financement, fiscalite et rentabilite.', steps: ['Renseignez le client et le bien immobilier','Completez le financement et les conditions','Editez les zones de texte (accompagnement, fiscalite, rentabilite)','Exportez le dossier en PDF pour le client'], tips: ['Chaque zone est editable : cliquez pour personnaliser','Verifiez le profil conseiller pour le pied de page'] },
    'tracking':            { title: 'Mail Manager & Expert', intro: 'Redigez en un clic votre mail hebdomadaire (Manager ou Expert). Remplissez vos objectifs une fois, ajustez l\'activite de la semaine, copiez-collez.', steps: ['Choisissez le mode : Manager (filleuls) ou Expert (1,5 M€ min.)','Renseignez une fois vos objectifs et votre identite (sections Memorise)','Chaque semaine, remplissez Semaine passee / Cette semaine et les compteurs RDV','Le Cette semaine se reporte automatiquement en Semaine passee la semaine suivante','Cliquez Copier l\'email et collez-le dans Gmail / Outlook'], tips: ['Les titres en gras survivent au copier-coller (gras Unicode)','Le Reste a faire se calcule automatiquement a partir de vos objectifs et VA','Effacer cette semaine ne touche pas vos objectifs memorises'] },
    'udp-prep':            { title: 'Preparation UDP',          intro: 'Preparez chaque Universite du Patrimoine comme une campagne : objectifs chiffres, check-lists de mise en action, questions aux formateurs et modeles a suivre.', steps: ['Choisissez l\'edition et renseignez la date des UDP','Fixez vos objectifs : R1 a fixer et invitations DM','Cochez la mise en action Conquete client : primoliste + jeu du "pourquoi je l\'appelle"','Cochez la mise en action Dev Action : equipe ideale, insatisfactions reperees, SMS, bloc d\'appels','Comptez vos R1 et invitations DM obtenus avec les compteurs + / -','Preparez vos questions aux consultants et identifiez 1 a 3 modeles'], tips: ['Les actions se font en session commune si prevue, sinon en solo - toujours avec la boite a outils (scripts)','Le statut "J\'y vais" se synchronise avec l\'agenda evenements de la page Outils','Le score "Suis-je pret pour les UDP" se met a jour automatiquement','Exportez le PDF et emportez-le aux UDP'] }
  };
  ...
  function boot() {
    ...
    if (guide && !guideSeen() && moduleId !== 'etude-dossier' && moduleId !== 'allocation-cible') {
