...
(function() {
  ...
  var GUIDES = {
    ...
    'etude-transfert-per': { title: 'Transfert PER/AV',       intro: 'Analysez l\'interet d\'un transfert de PER ou d\'assurance vie.', steps: ['Selectionnez la famille et le type de contrat actuel','Renseignez capital et allocations','Ajustez les frais de transfert et d\'entree','Visualisez breakeven et projection'], tips: ['Les frais de transfert sont nuls apres un certain nombre d\'annees'] },
    ...
    'suivi-contrat':       { title: 'Suivi de contrat',        intro: 'Generez une annexe de suivi structuree a partir d\'un export contrat, avec calcul du TRI annualise (XIRR).', steps: ['Collez l\'export complet de la fiche contrat dans la sidebar','Cliquez sur Analyser l\'export','Completez ou corrigez les champs client / contrat si besoin','Redigez vos commentaires conseiller dans les zones editables','Exportez en PDF pour l\'inserer dans la fiche client'], tips: ['Le TRI exclut automatiquement OST, arbitrages et interets (flux internes)','Seuls les mouvements volontaires >= 1 000 EUR apparaissent dans l\'historique'] },
