...
(function() {
  ...
  var GUIDES = {
    ...
    'allocation-cible':    { title: 'Allocation Cible',       intro: 'Dynamisez une poche (fonds euros) vers des fonds actions et visualisez l\'allocation finale.', steps: ['Renseignez le versement brut et les frais d\'entree','Saisissez l\'allocation de depart (dont la poche a dynamiser)','Choisissez le fonds source, cochez ou non \"vider la poche\", puis la duree ou le montant par arbitrage','Definissez les fonds de destination (fonds actions) en %','Lisez l\'allocation finale et les camemberts par famille d\'actif'], tips: ['Le montant par arbitrage se calcule automatiquement selon la duree et le montant','Vider la poche source : le fonds tombe a zero (au rythme de la duree ou du montant/arbitrage)','Ouvrez le \"Mode d\'emploi\" detaille depuis la sidebar'] },
