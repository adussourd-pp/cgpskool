...
(function() {
  ...
  var GUIDES = {
    ...
    'udp-prep':            { title: 'Preparation UDP',          intro: 'Preparez chaque Universite du Patrimoine comme une campagne : objectifs chiffres, check-lists de mise en action, questions aux formateurs et modeles a suivre.', steps: ['Choisissez l\'edition et renseignez la date de l\'UDP','Fixez vos objectifs : R1 a fixer et invitations DM','Cochez la mise en action Conquete client : primoliste + jeu du "pourquoi je l\'appelle"','Cochez la mise en action Dev Action : equipe ideale, insatisfactions reperees, SMS, bloc d\'appels','Comptez vos R1 et invitations DM obtenus avec les compteurs + / -','Preparez vos questions aux consultants et identifiez 1 a 3 modeles'], tips: ['Les actions se font en session commune si prevue, sinon en solo - toujours avec les scripts','Le score "Suis-je pret pour l\'UDP" se met a jour automatiquement','Exportez le PDF et emportez-le a l\'UDP'] }
  };
